...
public class deckplayer2 extends JPanel implements KeyListener {
    ...
    private String[] deck2 = new String[30];
    ...
    public deckplayer2() {
        ...
        ImageIcon referencia = new ImageIcon("banco_i/deckjogador2.png");
        ...
        Confirmar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              embaralharDeck(deck2);
               parentFrame.irPraraDuelo();
            }
        });
...
//movimentação e adição a lista
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (key == KeyEvent.VK_ENTER) {
            if (x == 580 && y == 55) {
                for (int i = 0; i < getDeck2().length; i++) {
                    if (getDeck2()[i] == null) {
                        getDeck2()[i] = "lobo";
                        break;
                    }
    ...
    public void printDeck() {
        for (int i = 0; i < getDeck2().length; i++) {
            if (getDeck2()[i] != null) {
                System.out.println("Deck 2 [" + i + "] = " + getDeck2()[i]);
                verificarDeckCheio();
